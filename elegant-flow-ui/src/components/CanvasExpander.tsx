...
export function CanvasExpander({
    ...
    return (
        <Card className="w-full" role="region" aria-label="Canvas expansion tools">
            <CardHeader>
                <CardTitle id="canvas-expander-title">Canvas Expander</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6" aria-labelledby="canvas-expander-title">
                ...
                {!previewImageUrl && originalDimensions && targetDimensions && (
                    <div className="space-y-2" role="region" aria-label="Expansion preview">
                        ...
                        <div className="relative w-full aspect-video rounded-lg overflow-hidden border-2 border-dashed border-primary bg-muted p-4">
                        ...
                        {ASPECT_RATIO_PRESETS.map((preset) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`p-4 text-left rounded-lg border-2 transition-all ${isAlreadyAtRatio
